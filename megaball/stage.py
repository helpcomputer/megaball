                ...
                for xc in range(WIDTH_TILES):
                    ...
                    if tile == POCKET_TILE_NW:
                        if x < self.tmu + WIDTH_TILES-1 and y < self.tmv + HEIGHT_TILES-1:
                            if pyxel.tilemaps[self.tm].pget(x+1, y) == POCKET_TILE_NE and\
                                pyxel.tilemaps[self.tm].pget(x+1, y+1) == POCKET_TILE_SE and\
                                pyxel.tilemaps[self.tm].pget(x, y+1) == POCKET_TILE_SW:
